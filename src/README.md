...
Activity data and sessions are stored in memory, which means activity changes and logins reset when the server restarts. Teacher credentials are stored as SHA-256 hashes in `teachers.json`; change the demo credential before deploying.
